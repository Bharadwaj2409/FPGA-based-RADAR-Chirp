...
HLS_SOURCES = ../../../../chirp_tb.cpp ../../../../chirp.cpp
...
$(ObjDir)/chirp_tb.o: ../../../../chirp_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../chirp_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/chirp_tb.d

$(ObjDir)/chirp.o: ../../../../chirp.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../chirp.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=chirp $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/chirp.d
