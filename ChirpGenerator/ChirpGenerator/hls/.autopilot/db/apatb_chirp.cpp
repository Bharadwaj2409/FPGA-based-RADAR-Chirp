...
// wrapc file define:
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.chirp.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.chirp.autotvout_out_r.dat"
#define AUTOTB_TVIN_fs "../tv/cdatafile/c.chirp.autotvin_fs.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.chirp.autotvout_out_r.dat"
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_fs),
#endif
  };
  port0.param = &__xlx_apatb_param_fs;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_f0),
#endif
  };
