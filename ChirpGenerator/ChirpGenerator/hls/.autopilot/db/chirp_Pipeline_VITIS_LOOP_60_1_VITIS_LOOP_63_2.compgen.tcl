...
set name chirp_fadd_32ns_32ns_32_5_full_dsp_1
...
set name chirp_fcmp_32ns_32ns_1_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chirp_chirp_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_63_2_ref_4oPi_table_100_ROM_1P_LUTRbkb BINDTYPE {storage} TYPE {rom_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chirp_chirp_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_63_2_second_order_float_sin_cos_K0_cud BINDTYPE {storage} TYPE {rom_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chirp_chirp_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_63_2_second_order_float_sin_cos_K1_dEe BINDTYPE {storage} TYPE {rom_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chirp_chirp_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_63_2_second_order_float_sin_cos_K2_eOg BINDTYPE {storage} TYPE {rom_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln11 \
    op interface \
    ports { mul_ln11 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln75_1 \
    op interface \
    ports { bitcast_ln75_1 { I 31 vector } } \
} "
}
