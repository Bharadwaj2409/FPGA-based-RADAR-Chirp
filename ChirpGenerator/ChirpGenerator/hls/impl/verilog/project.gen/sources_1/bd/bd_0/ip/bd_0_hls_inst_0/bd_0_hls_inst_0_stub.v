...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,chirp,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,chirp,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=chirp,x_ipVersion=1.0,x_ipCoreRevision=2114748067,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module bd_0_hls_inst_0(out_r_ce0, out_r_we0, ap_clk, ap_rst, ap_done, 
  ap_idle, ap_ready, ap_start, out_r_address0, out_r_d0, fs, f0, f1)
/* synthesis syn_black_box black_box_pad_pin="out_r_ce0,out_r_we0,ap_rst,ap_done,ap_idle,ap_ready,ap_start,out_r_address0[9:0],out_r_d0[31:0],fs[31:0],f0[31:0],f1[31:0]" */
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 out_r_address0 DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME out_r_address0, LAYERED_METADATA undef" *) output [9:0]out_r_address0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 f1 DATA" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME f1, LAYERED_METADATA undef" *) input [31:0]f1;
endmodule
